...
#else
	B_UINT32 psfParameterSet;	/**<  structure ParameterSet*/
#endif
...
#else
	/// \brief structure AuthorizedSet
	B_UINT32 psfAuthorizedSet;	/**<  AuthorizedSet of type stServiceFlowParamSI*/	
	/// \brief structure AdmittedSet
	B_UINT32  psfAdmittedSet;	/**<  AdmittedSet of type stServiceFlowParamSI*/
	/// \brief structure ActiveSet
	B_UINT32 psfActiveSet;	/**<  sfActiveSet of type stServiceFlowParamSI*/
#endif

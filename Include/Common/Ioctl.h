...
{
	PVOID	InputBuffer;
	B_UINT32	InputLength;
	PVOID	OutputBuffer;
	B_UINT32	OutputLength;
...
#define IOCTL_SET_HOST_STATS_MIBS           _IOWR(BCM_IOCTL, 0x90E, int)
...
enum {
  ...
  WIMAX_SPIO_IDX,/*To access WiMAX chip SPIO's for GPIO_MULTI_INFO or GPIO_MULTI_MODE*/
  MAX_IDX
};
...
typedef struct _BCMPayLoadHostMIB
{
  USHORT usType;
  USHORT usSubType;
  UINT32 uiLength;
